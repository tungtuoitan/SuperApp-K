...
## WebSocket nhanh vì connection luôn mở?
...
## Khi vào `localhost:3000`, browser lấy HTML/CSS/JS thế nào?
...
## Khi chạy `localhost:3000`, request có IP nguồn là gì?
...
## Tại sao HMR lỗi khi dùng USB debug mà không config?
