...
## process hầu hết bind trên ip của chính máy nó đang chạy phải không?
## `0.0.0.0` nghĩa là gì?
...
## máy nhận được request từ internet và máy không nhận được thì khác nhau chỗ nào? và chúng gọi là gì?
...
## các lợi ích phổ biến cụ thể mà public/private profile mang lại?
