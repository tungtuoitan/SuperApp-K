...
# làm sao để biết được dùng await có lợi hơn là không dùng? vì sao?  [id:3332 order:6]
hầu như LUÔN dùng await cho I/O. 
vì chi phí context switch nhỏ không đáng so với việc giữ thread chờ I/O.

# vì dùng await thì phải tốn tài nguyên cho context switch?
Có, 

# chi phí context switch có đáng kể không?
không
nó rất nhỏ (~µs), không đáng so với lợi ích giải phóng thread trong lúc chờ I/O.
