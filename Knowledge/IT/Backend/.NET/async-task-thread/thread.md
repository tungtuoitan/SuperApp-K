...
# ý nghĩa của tên Kernel? [id:3364 order:7]
...
# Kernel xử lí toàn bộ hoạt động I/O phải không? [id:3365 order:8]
Đúng.
...
# hoạt động IO là gì? ? [id:3366 order:9]
