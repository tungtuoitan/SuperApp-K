...
# tại sao fixed size và lưu liên tiếp thì performance tốt?
...
# traverse khác gì interate?
trong văn nói là 1



# truy cập tức là đọc phải không?
Không. 
...
# code càng gần phần cứng thì càng ít abstraction phải không? tại sao? [id:3161 order:7]
Đúng. 
Vì Càng gần phần cứng, dev càng phải tự xử lý chi tiết — không có lớp che.

# so sánh code bậc cao và code bậc thấp?
...
# tại sao code bậc thấp thì performance tốt hơn?
...
# data type nào hay bị phân mảnh? [id:3167 order:13]
class, string, object
