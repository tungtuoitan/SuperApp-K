...
# Phân biệt CLR, Runtime, Runtime engine, Execution engine? [id:2777 order:3]
...
# Phân biệt Runtime và Virtual machine? [id:2778 order:4]
...
# Bytecode là gì? [id:2789 order:15]
...
# Intermediate language là gì? [id:2790 order:16]
...
# Machine code là gì? [id:2791 order:17]
...
# tại sao không dịch code c# sang machine code luôn?
...
# 1 file dll chỉ chạy được trên 1 cpu cụ thể thôi à?
...
# Khi ứng dụng Go chạy, chuyện gì xảy ra? [id:2796 order:22]
