...
# mặc định thì k có middleware nào cả phải không? tức request sẽ đi đến Kestrel và đến thẳng controller ? [id:2859 order:6]
...
# routing, endpoint cũng là middleware à? nhiệm vụ của chúng là gì? [id:2860 order:7]
...
# request đi qua những gì trước khi đến db? [id:2864 order:11]
1. Kestrel
...
# pipeline là gì? [id:2921 order:12]
là chuỗi các middleware

# trong MinimalAPI có pipeline không? [id:2922 order:13]
Có.