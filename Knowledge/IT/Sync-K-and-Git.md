...
# azure webjob có phải là job không? nếu k thì nó là gì? [id:3063 order:12]
không, nó là deamon
...
# azure webjob có thể chạy độc lập k cần azure phải không? [id:3064 order:13]
đúng.
...
# analogy là gì? [id:2677 order:14]
...
# bootstrap là gì? [id:2679 order:15]
...
# Các ý nghĩa của host? [id:2681 order:16]
là máy chủ
tên miền
ip

# runtime là gì? [id:2682 order:17]
...
# phân biệt host, process, runtime? [id:2683 order:18]
...
# mặc định tài nguyên cấp cho 1 process là k giới hạn phải không? [id:2686 order:19]
...
# khi nào nên để deamon nằm trong api server? [id:2687 order:20]
...
# nếu daemon chạy trong api server thì khi api restart, daemon có mất state không? [id:2688 order:21]
...
# làm sao để daemon trong api server không mất tiến độ khi restart? [id:2689 order:22]
